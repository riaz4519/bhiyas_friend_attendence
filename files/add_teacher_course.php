                                        ...
                                        <div class="col">
                                           ...
                                           <select id="teacher" name="teacher" class="form-control" required>
                                               ...
                                               ?>
                                                    ...
                                                    <option <?php if (isset($_GET['teacher'])){
                                                        echo  $_GET['teacher'] == $single_teacher->id ? 'selected':'';
                                                    }  ?>  value="<?php echo $single_teacher->id ?>"><?php echo $single_teacher->name ?></option>
                                            ...
                                            <select id="semester" name="semester" class="form-control" required>
                                                ...
                                                while ($single_semester = $semesters->fetch_object()){
                                                    ...
                                                    <option  <?php if (isset($_GET['semester'])) {
                                                        echo  $_GET['semester'] == $single_semester->id ? 'selected':'';
                                                    } ?> value="<?php echo $single_semester->id ?>"><?php echo $single_semester->semester ?></option>
